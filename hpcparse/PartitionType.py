...
class PartitionType:
    ...
    def __str__(self):
        return """Job (alloc_nodes:{}, allow_accounts:{}, allow_groups:{},
        ...
        partition_name:{}, preempt_mode:{}, priority_job_factor:{},
        priority_tier:{}, qos:{}, req_resv:{}, root_only:{},
        select_type_parameters:{}, state:{}, tres_billing_weights:{}""".format(
                                                self.alloc_nodes,
                                                self.allow_accounts,
                                                self.allow_groups,
                                                self.allow_qos,
