class Job:
 ...
 max_disk_write:{}, max_disk_write_node:{}, max_disk_write_task:{}, max_pages:{}, max_pages_node:{}, max_pages_task:{}, memory:{},
 memory_node:{}, memory_task:{}, max_VM_size:{}, max_VM_size_node:{}, max_VM_size_task:{}, mcs_label:{}, min_cpu:{}, min_cpu_node:{},
 min_cpu_task:{}, NcpuS:{}, NNodes:{}, node_list:{}, num_tasks:{}, priority:{}, partition:{}, qos:{}, qos_raw:{}, req_cpu_freq:{},
 ...
 self.max_pages_node, self.max_pages_task,  self.memory, self.memory_node, self.memory_task, self.max_VM_size, self.max_VM_size_node,
 ...
 self.num_tasks, self.priority, self.partition, self.qos_raw, self.qos_raw, self.req_cpu_freq, self.req_cpu_freq_min, self.req_cpu_freq_max,
 ...
 'max_pages_task':self.max_pages_task, 'memory':self.memory, 'memory_node':self.memory_node,
 'memory_task':self.memory_task, 'max_VM_size':self.max_VM_size, 'max_VM_size_node':self.max_VM_size_node,
 ...
 'node_list':self.node_list, 'num_tasks':self.num_tasks, 'priority':self.priority, 'partition':self.partition,
