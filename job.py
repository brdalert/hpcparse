class Job:
    ...
    def __str__(self):
        ...
        user_cpu: {}, wc_key: {}, wc_key_id: {}, working_dir: {} )"""\
            .format(self.account, self.admin_comment, self.alloc_cpuS,
                    ...
                    self.min_cpu_node, self.min_cpu_task, self.NcpuS,
                    self.NNodes, self.node_list, self.num_tasks, self.priority,
                    self.partition, self.qos_raw, self.qos_raw,
    ...
    def __repr__(self):
        return {'account': self.account, 'admin_comment': self.admin_comment,
                ...
                'min_cpu_task': self.min_cpu_task, 'NcpuS': self.NcpuS,
                'NNodes': self.NNodes, 'node_list': self.node_list,
